...
which makes them identical in the context of monitoring. This is why we will refer to them as $SPE/R$ throughout the rest of the paper.

A common pattern we observe in these three works is that they claim to formulate direct extensions of the $ \Tsq $ and $ Q $ statistics of PCA-based monitoring.
This is done by breaking the tractable formulation of \ref{eqn:VAELoss} into two terms: $\E_{\mbz\sim q_{\mbtheta}}\log\decoding$ and $\KL{\encoding}{p(\mbz)}$.
